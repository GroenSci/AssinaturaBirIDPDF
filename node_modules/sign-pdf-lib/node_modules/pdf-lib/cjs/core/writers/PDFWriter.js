...
var PDFWriter = /** @class */ (function () {
    ...
    PDFWriter.prototype.serializeToBuffer = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        incremental = !(this.snapshot instanceof api_1.DefaultDocumentSnapshot);
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        trailerDict = PDFTrailerDict_1.default.of(this.createTrailerDict(this.snapshot.prevStartXRef));
    ...
    PDFWriter.forContext = function (context, objectsPerTick) {
        return new PDFWriter(context, objectsPerTick, api_1.defaultDocumentSnapshot);
    };
