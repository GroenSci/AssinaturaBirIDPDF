...
var PDFDocument = /** @class */ (function () {
    ...
    PDFDocument.prototype.takeSnapshot = function () {
        var indirectObjects = [];
        return new snapshot_1.IncrementalDocumentSnapshot(this.context.largestObjectNumber, indirectObjects, this.context.pdfFileDetails.pdfSize, this.context.pdfFileDetails.prevStartXRef, this.context);
    };
